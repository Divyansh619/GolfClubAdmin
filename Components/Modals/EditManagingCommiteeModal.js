...
export default function EditManagingCommiteeModal(props) {
                  ...
                  <div className="divide-y divide-green-400">
                    <div className="flex flex-col space-y-4">
                      ...
                      <div className="flex flex-col">
                        ...
                        {props.filterListData.image &&
                        typeof props.filterListData.image === "string" ? (
                          <div className="mt-2">
                            <a
                              href={props.filterListData.image}
                              target="_blank"
                              rel="noopener noreferrer"
                            >
                              <img
                                src={props.filterListData.image}
