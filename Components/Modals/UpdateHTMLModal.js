...
export default function UpdateHTMLModal(props) {
  ...
  const [editedContent, setEditedContent] = useState(
    props.filterListData.HtmlDescription
  );
  ...
  const [hint, setHint] = useState(
    "Upload JPEG, JPG, PNG, or SVG images (max 2MB, 700x600 pixels)."
  );
  ...
  const updateHTMLModal = () => {
    ...
    formdata.append("HtmlDescription", editedContent);

    formdata.append("AboutUsUUID", props.filterListData.AboutUsUUID);
    ...
    fetch(
      "https://stgadmin.sasone.in/api/LGCadmin/AboutUsUpdate",
      requestOptions
    )
          ...
          >
            ...
            <div className="fixed inset-0 z-50 w-screen overflow-y-auto">
              <div className="flex min-h-full items-center justify-center p-4 text-center sm:items-center sm:p-0">
                ...
                >
                  <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl  p-4 transition-all sm:my-8 w-full sm:max-w-2xl">
                    <form
                      onSubmit={(e) => {
                        e.preventDefault();
                        updateHTMLModal();
                      ...
                      className="mb-4"
                    >
                      <div className="max-w-xl mx-auto mt-4 bg-white   ">
