...
const UpdateTestimonialModal = (props) => {
  ...
  const updateHTMLModal = () => {
    ...
    formdata.append("Testimonial", editedTestimonial);
    formdata.append("MemberName", editedMemberName);
    formdata.append("TestimonialUUID", props.filterListData.TestimonialUUID);
    ...
    fetch(
      "https://stgadmin.sasone.in/api/LGCadmin/TestimonialsUpdate",
      requestOptions
    )
                    ...
                    >
                      <div className="max-w-md mx-auto mt-4 bg-white   ">
                        ...
                        className="border border-gray-300 rounded-md px-4 py-1 focus:outline-none focus:border-blue-500"
                                ...
                                rows={4}
                                onChange={(e) =>
                                  setEditedTestimonial(e.target.value)
                                }
                              />
                              {/* <DynamicJoditEditor
                                ref={editor}
