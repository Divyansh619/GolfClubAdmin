...
export default function AddHTMLModal(props) {
    ...
    const insertAboutUs = () => {
        ...
        formdata.append("HtmlDescription", content);
        ...
        fetch("https://stgadmin.sasone.in/api/LGCadmin/AboutUsInsert", requestOptions)
    ...
    return (
        <>
            {open ? <SuccessMessage open={open} setOpen={props.setOpen} message={message} success={success} />
                            ...
                            <div className="flex min-h-full items-center justify-center p-4 text-center sm:items-center sm:p-0">
                                ...
                                >
                                    <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl  p-4 transition-all sm:my-8 w-full sm:max-w-lg">
                                        <form onSubmit={(e) => { e.preventDefault(); insertAboutUs() }} className='mb-4'>
                                            <div className="max-w-md mx-auto mt-4 bg-white   ">
                                                ...
                                                <div className="divide-y divide-green-400">
                                                    <div className="flex flex-col space-y-4">
                                                        ...
                                                        <div className="flex flex-col">
                                                            <label htmlFor="name" className="text-black text-sm font-medium mb-1">HTML Description</label>
                                                            <DynamicJoditEditor
                                                                ref={editor}
                                                                value={content}
                                                        ...
                                                        {/* <div className="flex flex-col">
                                                            <label htmlFor="profileImage" className="text-black text-sm font-medium mb-1">
                                                                ...
                                                                <div className="border flex justify-between items-center border-gray-300 rounded-md px-2 py-2 focus:outline-none focus:border-blue-500">
                                                                    {addImage ? (
                                                                        <img
                                                                            src={typeof addImage === 'string' ? addImage : URL.createObjectURL(addImage)}
                                                                            alt="Profile"
                                            ...
                                            <div className=" py-3 sm:flex sm:flex-row-reverse sm:px-6">
                                                ...
                                                >
                                                    {loading === "insert" ? <div className="flex item-center  "> <svg aria-hidden="true" role="status" class="inline w-4 h-4 me-3 mt-0.5 text-gray-200 animate-spin dark:text-gray-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    ...
                                                    </svg> <span>processing...</span></div> : props.btn}
                                                </button>
                                                <button
                                                    type="button"
