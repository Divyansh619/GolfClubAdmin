...
export default function GolfEditModal(props) {
                        ...
                        >
                            <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl  p-4 transition-all sm:my-8 w-full sm:max-w-lg">
                                ...
                                <div className="max-w-md mx-auto mt-1 bg-white   ">
                                    <h1 className="text-center font-semibold my-3">{props.heading}</h1>
                                    <div className="divide-y divide-green-400">
                                        <div className="flex flex-col space-y-4">
                                            {/* <div className="flex flex-col">
                                                <label htmlFor="name" className="text-black text-sm font-medium mb-1">Rule No</label>
                                                <input
                                                    id="name"
                                                    className="border border-gray-300 rounded-md px-4 py-1 focus:outline-none focus:border-blue-500"
                                                    type="text"
                                                    value={props.filterListData.RuleNo}
                                                    onChange={(e) => props.setEditedTitle({ ...props.filterListData, RuleNo: e.target.value })}
                                                />
                                            </div> */}
                                            ...
                                            <div className="flex flex-col">
                                                ...
                                                <input
                                                    ...
                                                    className="border border-gray-300 rounded-md px-4 py-1 focus:outline-none focus:border-blue-500"
                                                    type="text"
                                                    value={props.filterListData.RuleDescription}
                                                    onChange={(e) => props.setEditedDescription({ ...props.filterListData, RuleDescription: e.target.value })}
                                                />
                                            </div>
                                            ...
                                            <div className="flex items-center">
                                                <input
                                                    ...
                                                    className="mr-2"
                                                    type="checkbox"
                                                    checked={props.filterListData.IsLive==="1"?true:false}
                                                    onChange={(e) =>
                                                        props.setEditedTitle({ ...props.filterListData, IsLive: e.target.checked })}
                                                />
