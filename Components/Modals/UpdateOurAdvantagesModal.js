...
const UpdateOurAdvantagesModal = (props) => {
  ...
  const [editedLogo, setEditedLogo] = useState(props.filterListData.Logo || "");
  ...
  const updateHTMLModal = () => {
    ...
    formdata.append("OurAdvantageUUID", props.filterListData.OurAdvantageUUID);
    formdata.append("IsLive ", isLive ? 1 : 0);
    formdata.append("Logo", typeof editedLogo === "string" ? "" : editedLogo);
    ...
    fetch(
      "https://stgadmin.sasone.in/api/LGCadmin/AdminClubAdvantagesUpdate",
      requestOptions
    )
      ...
      .then((result) => {
        if (result.status_code === 200 && result.status === "Success") {
          ...
          setMessage("Our advantage details updated successfully!!");
          setSuccess(true);
          setOpen(true);
                      ...
                      <div className="max-w-md mx-auto mt-4 bg-white   ">
                        ...
                        <div className="divide-y divide-green-400">
                          <div className="flex flex-col space-y-4">
                            ...
                            {/* <div className="flex flex-col">
                            <label htmlFor="icon" className="text-black text-sm font-medium mb-1">
                              Image
                              <input
                                id="icon"
                                ...
                                hidden
                                accept="image/*"
                                onChange={(e) => { setEditedLogo(e.target.files[0]) }}
                              />
                              <div className="border flex justify-between items-center border-gray-300 rounded-md px-2 py-2 focus:outline-none focus:border-blue-500">
                                {editedLogo ? (
                                  <img
                                    src={typeof editedLogo === 'string' ? editedLogo : URL.createObjectURL(editedLogo)}
                                    alt="Profile"
...
export default UpdateOurAdvantagesModal;
